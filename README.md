...
- [Full workflow](#full-workflow)
  ...
  - [Day 1: First-time setup](#day-1-first-time-setup)
  - [Day 2 onwards: Spec stays in sync automatically](#day-2-onwards-spec-stays-in-sync-automatically)
  - [When a new Jira ticket lands](#when-a-new-jira-ticket-lands)
- [Command details](#command-details)
  - [`/qa-api-test-setup`](#qa-api-test-setup)
  - [Main-collection folder structure](#main-collection-folder-structure)
  - [`/qa-test-ticket <JIRA-KEY>`](#qa-test-ticket-jira-key)
  - [Ticket-collection folder structure](#ticket-collection-folder-structure)
  - [`/qa-api-sync`](#qa-api-sync)
  - [`/qa-negative-audit`](#qa-negative-audit)
- [Scheduling deep-dive](#scheduling-deep-dive)
- [Project files](#project-files)
- [How the template flow works](#how-the-template-flow-works)
- [What gets generated by `./run-tests.sh`](#what-gets-generated-by-run-testssh)
- [`.env` keys](#env-keys)
- [Running tests](#running-tests)
- [When tests fail (auto-fix → debug → Jira)](#when-tests-fail-auto-fix-first-then-debug-then-log-to-jira)
